...
1. Run MarteX behind a Tor proxy
---------------------------------
...
In a typical situation, where you're only reachable via Tor, this should suffice:
  ...
  ./MarteXd -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
  ...
  ./MarteXd -tor=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
